 ...
 *
 * What it does:
 *   1. Creates the `itineraries` table (if it doesn't exist yet)
 *   2. Imports the old saved_itineraries.json into the table (skips ids that
 *      are already in the database, so re-running is safe)
 *
 * How to run: open  https://yourdomain/install.php  in the browser
 *        (or:  php install.php  from an SSH terminal)
 */
...
echo "\n>>> When both scripts have run, DELETE install.php from the server. <<<\n";
