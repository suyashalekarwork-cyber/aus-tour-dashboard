...
CORRECTIONS_PATH = Path(r'C:\Users\SuyashA\Downloads\Build and explore\token_corrections.json')
PREPARE_SCRIPT   = Path(r'C:\Users\SuyashA\Downloads\Build and explore\prepare_data.py')
